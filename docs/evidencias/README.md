...
Este directorio reúne capturas y registros obtenidos en ejecuciones reales del proyecto.

- `reserva-confirmada-local.png`: resultado de la reserva durante la comprobación local.
...
- `github-branches.png`: ramas publicadas en el repositorio.
